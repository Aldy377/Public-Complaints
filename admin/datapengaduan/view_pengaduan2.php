...
$query = "SELECT * FROM pengaduan where status = 'proses' ORDER BY id_pengaduan DESC";
		...
		<table id="example" class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="" class="btn btn-info isi" id="<?php echo $row['id_pengaduan'];?>" data-toggle="modal" data-target="#isi">Beri Tanggapan</a>
