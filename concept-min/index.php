...
<div class="container">
	<div class="row text-center">
		...
		<div class="col-md-4">
				<img src="">	
				<h3> GAME TIME </h3>
				<p>	Jadikan waktu bermain anda lebih santai dengan sambil menikmati menu yang ada di toko kami..
				Mau nunggu apa lagi ?? Ayo datang SEKARANG!!!!!
				</p>
		</div>
		<div class="col-md-4">
				<img src="">
				<h3> IDEA TIME </h3>
				<p>	Kembangkan semua ide mu disini, dan jadikan lah sebuah karya yang sangat bernilai..
				Mau nunggu apa lagi ?? Ayo kembangkan sekarang!!!!!!	</p>
		</div>
		<div class="col-md-4">
				<img src="">
				<h3> LEARN TIME </h3>
				<p>	Belajar adalah pangkal pandai, namun belajar pun tidak harus selalu di tekan kan. Belajarlah dengan santai Bersama kami disini!! Ayooo BELAJARR!!!!!</p>
		</div>
	</div>
</div>
</section>
